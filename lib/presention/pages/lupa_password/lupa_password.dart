        ...
        child: LayoutBuilder(builder: (context, contstraints) {
          return SingleChildScrollView(
              child: ConstrainedBox(
                  constraints:
                      BoxConstraints(minHeight: contstraints.minHeight),
                  child: Center(
                    child: Column(
                                  ...
                                  child: SizedBox(
                                    ...
                                    child: ElevatedButton(
                                      ...
                                      onPressed: isProfileCompleted()
                                          ? () {
                                              BlocProvider.of<ForgotPassCubit>(
                                                      context)
                                                  .btnForgotPass(ForgotPassword(
                                                      whatssapController.text));
                                            }
                                          : null,
                                      child: BlocBuilder<ForgotPassCubit,
                                          ForgotPassState>(
                                        builder: (context, forgotPassState) {
                                          if (forgotPassState
                                              is ForgotPassIsLoading) {
                                            return const Center(
                                                child:
