...
class _AutentikasiScreenState extends State<AutentikasiScreen> {
  late AutentikasiCubit _autentikasiCubit;

  @override
  void initState(){
    super.initState();
    _autentikasiCubit = AutentikasiCubit(AutentikasiRepositoryImpl());
  }

  @override
  void dispose() {
    _autentikasiCubit.close();
    super.dispose();
  }
  @override
        ...
        body: BlocListener<AutentikasiCubit, AutentikasiState>(
          listener: (context, state) {
            ...
            if (state is AutentikasiIsError) {
              ...
              Commons().showSnackbarInfo(context, "Autentikasi Berhasil");
